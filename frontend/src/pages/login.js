...
import { useAppContext } from '../context'; // Use the custom hook
...
const Login = () => {
  ...
  const { fetchUserDetails,fetchUserAddToCart } = useAppContext(); // Use the custom hook
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (dataApi.success) {
        ...
        await fetchUserAddToCart();       // Ensure fetchUserDetails is awaited
        navigate("/");
      } else {
